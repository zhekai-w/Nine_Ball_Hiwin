...
static const _BoundingBox_type_support_symbol_names_t _BoundingBox_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detect_interface, msg, BoundingBox)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, detect_interface, msg, BoundingBox)),
  }
};
...
{
  return &::detect_interface::msg::rosidl_typesupport_cpp::BoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, detect_interface, msg, BoundingBox)() {
  return get_message_type_support_handle<detect_interface::msg::BoundingBox>();
}
