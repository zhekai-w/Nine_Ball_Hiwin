...
static const _DetectionResults_type_support_symbol_names_t _DetectionResults_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detect_interface, msg, DetectionResults)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, detect_interface, msg, DetectionResults)),
  }
};
...
{
  return &::detect_interface::msg::rosidl_typesupport_cpp::DetectionResults_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, detect_interface, msg, DetectionResults)() {
  return get_message_type_support_handle<detect_interface::msg::DetectionResults>();
}
